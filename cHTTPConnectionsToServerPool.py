...
#      oSelf.__oConnectionsPropertyLock.fRelease();
  ...
  def __fo0GetConnectionAndStartTransaction(
    ...
    while not oSelf.__bStopping:
      ...
      except cHTTPConnection.cHTTPMaxConnectionsToServerReachedException:
  ...
  def __fo0StartTransactionOnExistingConnection(oSelf,
    ...
    try:
      ...
      for oConnection in oSelf.__aoConnections:
        ...
        except cHTTPConnection.cTCPIPConnectionCannotBeUsedConcurrentlyException:
          fShowDebugOutput(oSelf, "Connection is in use.");
        except cHTTPConnection.cTCPIPConnectionShutdownException:
          fShowDebugOutput(oSelf, "Connection is shut down.");
        except cHTTPConnection.cTCPIPConnectionDisconnectedException:
  ...
  def __foCreateNewConnectionAndStartTransaction(oSelf,
    ...
    try:
      if (
        ...
        raise cHTTPConnection.cHTTPMaxConnectionsToServerReachedException(
